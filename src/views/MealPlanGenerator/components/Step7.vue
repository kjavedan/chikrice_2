<template>
  <div>
    ...
    <ElCheckboxGroup v-model="userInputsData.fruits" class="grid gap-4 justify-start">
      <ElCheckbox v-for="option in optionsData.fruits" :label="option.value" :key="option.value">
